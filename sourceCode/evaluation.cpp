...
short Evaluation::evaluateMaterial(const thc::ChessRules& board) {
    short score = 0;
...
short Evaluation::pieceSquareTables(const thc::ChessRules& board) {
...
int Evaluation::calculateMobilityForSide(thc::ChessRules& board, char side) {
    int mobility = 0;
...
short Evaluation::mobility(thc::ChessRules& board) {
...
short Evaluation::evaluate(thc::ChessRules& board){
